...
<div class="products">
   ...
   ?>
      <form method="post" class="box" action="">
         ...
         <div class="price">Pesos <?php echo $fetch_product['price']; ?>/-</div>
   ...
   <table>
      ...
      ?>
         <tr>
            ...
            <td>Pesos <?php echo $fetch_cart['price']; ?>/-</td>
            <td>
            ...
            <td>Pesos <?php echo $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?>/-</td>
      ...
      <tr class="table-bottom">
         ...
         <td>Pesos <?php echo $grand_total; ?>/-</td>
